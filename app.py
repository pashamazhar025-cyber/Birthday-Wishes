...
st.markdown(
    "<h1 style='text-align:center; color:#ff1493;'>🎉 Welcome to Molvi's Birthday App 🎉</h1>", 
...
if name:
    ...
    if st.button("📸 Press to See Your Memories"):
        ...
        current_folder = "."
        image_files = [f for f in os.listdir(current_folder) if f.lower().endswith((".jpg", ".jpeg", ".png", ".gif"))]
        ...
        video_files = [f for f in os.listdir(current_folder) if f.lower().endswith((".mp4", ".mov", ".mkv"))]
